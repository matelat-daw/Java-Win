...
/* ───────────────────────────────────────────────────────────────────
obtenerInfo()
 Llama a GET / info y devuelve el texto informativo.
─────────────────────────────────────────────────────────────────── */
async function obtenerInfo() {
    // TODO 9: implementa esta función igual que obtenerProductos()
    // pero llamando a /info y devolviendo el texto con .text() en lugar de .json()
    const respuesta = await fetch(`${API_BASE}/info`);
    if (!respuesta.ok) {
