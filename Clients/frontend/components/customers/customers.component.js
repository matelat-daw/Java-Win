...
class CustomersComponent {
    ...
    async init() {
        try {
            window.CustomersComponentInstance = this;
    ...
    getAdminViewHTML() {
        ...
        const displayName = AuthService.getFullName() || (currentUser ? (currentUser.nick || 'Usuario') : 'Usuario');
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="alert alert-info alert-dismissible fade show" role="alert">
                            ...
                            <strong>¡Bienvenido ${displayName}! Rol: ${role}. ${modeText} de Customers de MyIkea</strong>
    ...
    static getInstance() {
        if (window.CustomersComponentInstance) {
            return window.CustomersComponentInstance;
        }
        ...
        window.CustomersComponentInstance = window._customersComponent;
