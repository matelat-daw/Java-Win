...
class ProfileComponent {
    ...
    async init() {
        try {
            ...
            await Utils.loadHtml(this.selector, '/frontend/components/profile/profile.component.html');
    ...
    async handleUploadPicture(e) {
        ...
        try {
            ...
            const url = API_CONFIG.BASE_URL + API_CONFIG.ENDPOINTS.PROFILE_PICTURE;
            const result = await Utils.makeRequestWithFormData('POST', url, formData);
